...
val currentVersion = "0.4.1" //versioning.info.base.let { if (it.isEmpty()) "dev" else it }
...
publishing {
    repositories {
        maven {
            name = "GitHubPackages"
            url = uri("https://maven.pkg.github.com/ivanhai/old-bulma-kotlin")
            credentials {
                username = "ivanhai"
                password = "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"
            }
        }
    }
    publications {
